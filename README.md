...
I did, and I've hated it immediately.  
...
- Add sculk vain layer to many non-full blocks when Better Snow is enabled
- Add an optional built-in resource pack to better adapt the mod with Vanilla's look.
...
<a href="https://modrinth.com/mod/lambdabettergrass" style="display: inline-flex; align-items: center;" class="ls_download_item">
...
<a href="https://www.curseforge.com/minecraft/mc-mods/lambdabettergrass" style="display: inline-flex; align-items: center" class="ls_download_item">
...
<span style="display: inline-block; width: 1em"></span>
<a href="https://github.com/LambdAurora/LambdaBetterGrass/releases" style="display: inline-flex; align-items: center" class="ls_download_item">
