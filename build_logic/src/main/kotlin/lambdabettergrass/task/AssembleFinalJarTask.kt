package lambdabettergrass.task
...
abstract class AssembleFinalJarTask @Inject constructor() : AbstractAssembleJarTask() {
	...
	private fun doAssemble(outFs: FileSystem, fabricJarFs: FileSystem, neoJarFs: FileSystem) {
		this.createDirectories(outFs.getPath("dev/lambdaurora/lambdabettergrass"))
		this.biMove("dev/lambdaurora/lambdabettergrass/shadow", fabricJarFs, neoJarFs, outFs)
		this.biMove("META-INF/versions", fabricJarFs, neoJarFs, outFs)
		this.biMove("assets", fabricJarFs, neoJarFs, outFs)
		this.copy("lambdabettergrass.toml", fabricJarFs, outFs)
		this.copy("LICENSE_lambdabettergrass", fabricJarFs, outFs)

		this.copy("assets/lambdabettergrass/icon.png", outFs, fabricJarFs)
		this.copy("assets/lambdabettergrass/icon.png", outFs, neoJarFs)
	}
	...
	private fun writeFmj(fabricFs: FileSystem, outFs: FileSystem, outFabricJar: Path) {
		...
		parentFmj.withEntrypoints("modmenu", "dev.lambdaurora.lambdabettergrass.LambdaBetterGrassModMenu")
